    ...
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-500">
      ...
      >
        <div className="flex items-center gap-8">
          ...
          <a href={buildWhatsAppUrl(WHATSAPP, 'Hello')} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-amber-400 transition-colors" style={{ color: 'rgba(255,255,255,0.4)' }}>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              href={buildWhatsAppUrl(WHATSAPP, 'Hello, I would like to book a transfer in Italy.')}
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs font-medium px-4 py-2 rounded-sm transition-all"
              style={{ color: '#4ade80', border: '1px solid rgba(37,211,102,0.25)', background: 'rgba(37,211,102,0.06)', letterSpacing: '0.06em' }}
            >
              WhatsApp
            </a>
      ...
      {mobileOpen && (
        ...
        >
          ...
          <div className="px-6 pb-6 pt-2 flex flex-col gap-3">
            <a
              href={buildWhatsAppUrl(WHATSAPP, 'Hello, I would like to book a transfer.')}
              target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 py-4 rounded-sm text-sm font-semibold"
