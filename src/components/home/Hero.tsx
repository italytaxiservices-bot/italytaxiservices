    ...
    <section className="relative min-h-screen flex flex-col overflow-hidden grain" style={{ background: '#080808' }}>
        ...
        <div className="w-full grid lg:grid-cols-[1fr_440px] gap-14 items-center">
          ...
          <div>
            ...
            <h1 className="mb-8 leading-[0.95] tracking-tight">
              <span className="block text-white font-black" style={{ fontSize: 'clamp(2rem, 4.5vw, 4rem)' }}>
                The Finest
              </span>
              <span
              ...
              <span className="block font-black text-white" style={{ fontSize: 'clamp(1.8rem, 4vw, 3.5rem)' }}>
                Chauffeur Service
              </span>
            </h1>
            ...
            <div className="flex items-center gap-5 mb-10">
              <div style={{ height: '1px', width: '50px', background: 'linear-gradient(90deg, #C9A84C, transparent)', flexShrink: 0 }} />
              <p className="text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.52)', fontFamily: 'var(--font-serif), Georgia, serif', fontStyle: 'italic' }}>
            ...
            <div className="flex flex-wrap gap-x-7 gap-y-3">
              {['NCC Licensed', 'Fixed Prices', 'Flight Tracking', 'Meet & Greet', 'Free Cancellation'].map((t) => (
                <div key={t} className="flex items-center gap-2">
                  ...
                  <span className="text-xs" style={{ color: 'rgba(255,255,255,0.4)', letterSpacing: '0.03em' }}>{t}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="relative z-10" style={{ background: 'rgba(255,255,255,0.03)', borderTop: '1px solid rgba(201,168,76,0.12)', backdropFilter: 'blur(20px)' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-2 sm:grid-cols-4" style={{ borderColor: 'rgba(201,168,76,0.1)' }}>
