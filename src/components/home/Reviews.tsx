  ...
  return (
    <section className="py-32" style={{ background: '#F5F0E8' }}>
      <div className="max-w-5xl mx-auto px-6 lg:px-12 text-center">
        ...
        <h2 className="font-black leading-[0.95] mb-6" style={{ fontSize: 'clamp(2.6rem, 5vw, 4.2rem)', color: '#080808' }}>
          What Our Clients
          <br />
        ...
        <Link
          ...
          className="group inline-flex items-center gap-4 rounded-sm px-8 py-5 transition-colors duration-200"
