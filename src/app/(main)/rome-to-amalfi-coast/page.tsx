...
export const metadata: Metadata = {
  ...
  description: 'Rome to Amalfi Coast private transfer. From €380. Positano, Ravello, Amalfi served. SS163 experts — no rental car stress. Fixed price, licensed NCC. Book now.',
