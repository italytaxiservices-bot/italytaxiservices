...
export const metadata: Metadata = {
  ...
  description: 'Rated 4.9★ · Florence Airport (FLR) private transfer. From €30 to city centre. Pisa, Siena, Tuscany tours covered. Meet & greet, no hidden fees. Fixed price guaranteed.',
