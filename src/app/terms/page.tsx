...
export const metadata: Metadata = {
  title: 'Terms & Conditions | Italy Chauffeur',
  description: 'Terms and conditions for Italy Chauffeur NCC private transfer booking service.',
}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="space-y-8 text-gray-700 leading-relaxed">
            {[
              { title: '1. Service Description', body: 'Italy Chauffeur acts as an intermediary service connecting travellers with licensed NCC (Noleggio con Conducente) operators in Italy. We are not the direct transport provider but arrange transfers on behalf of our partner operators.' },
              { title: '2. Booking & Confirmation', body: 'Bookings are confirmed only after written confirmation from Italy Chauffeur via WhatsApp or email. A booking reference will be provided. No booking is confirmed until you receive explicit written confirmation from us.' },
              ...
              { title: '8. Liability', body: 'Italy Chauffeur\'s liability is limited to the value of the transfer booking. We are not liable for: delays caused by traffic, weather, or force majeure; indirect losses; or losses arising from missed connections.' },
              ...
              { title: '10. Contact', body: 'For any questions about these terms: info@italychauffeur.com' },
            ].map(({ title, body }) => (
              <div key={title}>
